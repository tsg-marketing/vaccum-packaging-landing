  ...
  const models = [
    {
      ...
      pump: '4 м³/ч',
      sealPower: '400 Вт',
      chamberSize: '270×265×70 мм',
      externalChamber: '310×340×105 мм',
      weight: '21 кг',
      packageSize: '425×455×275 мм',
      inStock: true,
      warranty: '3 года',
      price: 'от 49 900 ₽',
    ...
    },
    {
      ...
      pump: '8 м³/ч',
      sealPower: '500 Вт',
      chamberSize: '310×290×110 мм',
      externalChamber: '350×360×135 мм',
      weight: '35 кг',
      packageSize: '470×490×355 мм',
      inStock: true,
      warranty: '3 года',
      price: 'от 67 900 ₽',
      body: 'Нержавеющая сталь',
    ...
    },
    {
      ...
      pump: '20 м³/ч',
      sealPower: '500 Вт',
      chamberSize: '410×365×130 мм',
      externalChamber: '450×435×255 мм',
      weight: '105 кг',
      packageSize: '685×625×635 мм',
      inStock: true,
      warranty: '3 года',
      price: 'от 224 900 ₽',
      body: 'Нержавеющая сталь',
    },
    {
      ...
      pump: '20 м³/ч',
      sealPower: '500 Вт',
      chamberSize: '510×365×130 мм',
      externalChamber: '550×435×255 мм',
      weight: '115 кг',
      packageSize: '785×625×635 мм',
      inStock: true,
      warranty: '3 года',
      price: 'от 259 900 ₽',
      body: 'Нержавеющая сталь',
    },
    {
      ...
      pump: '40 м³/ч',
      sealPower: '800 Вт',
      chamberSize: '720×550×180 мм',
      externalChamber: '',
      weight: '215 кг',
      packageSize: '1050×770×1030 мм',
      inStock: true,
      warranty: '3 года',
      price: 'от 399 900 ₽',
      body: 'Нержавеющая сталь SUS304',
    },
    {
      id: 7,
      name: 'HVC-810S/2B (DZ-810S)',
      type: 'floor',
      chambers: 2,
      application: 'universal',
      image: 'https://cdn.poehali.dev/files/0a82f194-5bc8-4995-830b-c1cf62a9ec9f.jpg',
      ...
      pump: '63 м³/ч',
      sealPower: '1000 Вт',
      chamberSize: '810×550×180 мм',
      externalChamber: '',
      weight: '245 кг',
      packageSize: '1150×770×1030 мм',
      inStock: true,
      warranty: '3 года',
      price: 'от 479 900 ₽',
      body: 'Нержавеющая сталь SUS304',
            ...
            <div className="relative group">
              ...
              <div className="absolute left-0 top-full pt-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-50">
                <div className="bg-white border border-border shadow-lg rounded-lg py-2 min-w-[240px]">
                  <a href="/" className="block px-4 py-2 text-sm hover:bg-muted transition-colors font-semibold text-primary">Вакуумное оборудование</a>
          ...
          <div className="md:hidden border-t border-border bg-white animate-fade-in">
            <nav className="container mx-auto px-4 py-4 flex flex-col gap-3">
              <div className="py-2 border-b border-border">
                ...
                <a href="/" className="block text-sm text-primary font-semibold py-1.5 pl-3" onClick={() => setMobileMenuOpen(false)}>Вакуумное оборудование</a>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            <div className="relative">
              <img
                src="https://cdn.poehali.dev/files/Вакуумные_1.jpg"
